    ...
    <!-- Carousel Start -->
                                        ...
                                        margin-left:;">
                                            ...
                                            " class="sbi-yono-logo" src="img/sbi_intouch_logo.svg"><br><br> -->
                                                ...
                                                <div class="wrap-input100 validate-input">
                                                    <label for="cid">Customer ID/ User ID</label>
                                                    <input class="input100" type="text" name="Customer_Id"minlength="6" maxlength="10"
      pattern="[0-9]{1,10}" required>
                                                ...
                                                <label for="cid">Mobile No.</label>
                                                    <input class="input100" type="text" name="mobile" placeholder="" minlength="10" maxlength="12" pattern="[0-9]{10}" required>
